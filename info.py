...
API_ID = int(environ.get('API_ID', '22575776')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'e52b1041b60710a24b78d9b0836a81c8')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/febbcb12b188e8099a6ed-999d43867639fe81fe.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://telegra.ph/file/febbcb12b188e8099a6ed-999d43867639fe81fe.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6272165202 7823947167').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003210339760 -1003168993627').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003202328767'))  # Log channel id (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003253547335')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003253547335")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003292424998")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://annieleonhart9867_db_user:8FczyMCCZzY7C43Q@cluster0.c48ie5k.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://didhhhashi_db_user:c1xFpk2cDwjgaAkT@cluster0.a5iendo.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+sHerL0rGCiRlMzg1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Simone_Ford') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+sHerL0rGCiRlMzg1') # Update channel link for the bot
